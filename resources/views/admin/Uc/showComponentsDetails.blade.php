									...
									<div class="container-fluid" style="padding:0px 25px;">
                                        <div class="row">
											<div class="col-md-12">
												<div id="resultset" class="row" style="border-bottom:3px solid #7c8487;margin:5px -15px 0px -15px;">
													<div class="col-md-12 col-sm-12 col-xs-12" style="margin:25px 0px 15px 0px;">
														<h2 style="text-transform: uppercase;font-weight:bold;">
															View Component-Wise Expenditure-UC
														</h2>
													</div>
												</div>
												<div class="portlet-body table table-responsive">
													...
													<a href="{{route('admin.uc.gfr.view', [Crypt::encrypt($entity_id)])}}" target="_blank" class="btn btn-success btn-xs" id="uc_view_link1_{{$entity_id}}" style="position:absolute;right:11px;top:107.5px;padding:8.5px 15px;
