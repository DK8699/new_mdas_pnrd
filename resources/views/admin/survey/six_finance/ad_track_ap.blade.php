                    ...
                    <table class="table table-bordered" id="dataTable1">
                        ...
                        @foreach($results AS $res)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($res->zila_parishad_name){{$res->zila_parishad_name}} @endif
                                </td>
								<td>
                                    @if($res->anchalik_parishad_name){{$res->anchalik_parishad_name}}@endif
                                </td>
                                <td class="text-center">
                                    F_{{7-($res->basic_info+$res->staff_info+$res->revenue_info+
                                    $res->expenditure_info+$res->balance_info+$res->other_info+$res->five_year_info)}}
                                </td>
