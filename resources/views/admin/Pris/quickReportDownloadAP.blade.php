@php
    $page_title="quick-report-download-AP";
@endphp
...
@section('content')
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Elected Member Details AP</li>
        </ol>
    </div>
    <div class="container-fluid">
        <h1 style="text-align: center; font-family: 'Old Standard TT', serif;"><u>Elected Anchalik Panchayat Member Details in AreaProfiler Application</u></h1>
    ...
    <script>
        $(document).ready( function () {
            $('#laravel_datatable').DataTable({
                ...
                ajax: "{{ route('admin.Pris.servicePriAPNicDataList') }}",
                columns: [
                    ...
                    { data: 'ap_id', name: 'pri_member_main_records.anchalik_id' },
