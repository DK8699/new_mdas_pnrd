...
@section('content')
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">Female Sarpanches Details GP</li>
        </ol>
    </div>
    <div class="container-fluid">
        <h1 style="text-align: center; font-family: 'Old Standard TT', serif;"><u>Female Sarpanches Gram Panchayat  Under 30 Years</u> <span style="font-size: 20px">(as on 01/01/2019)</span></u></h1>
