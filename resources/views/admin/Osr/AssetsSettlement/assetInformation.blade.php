...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li class="active"> Asset :- {{$fy_years}}</li>
    </ol>
</div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12" style="background-color: #fff;margin-bottom: 40px">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data['assetData']->level=="ZP")
                                    {{"Zila Parishad"}}
                                @elseif($data['assetData']->level=="AP")
                                    {{"Anchalik Panchayat"}}
                                @else
                                    {{"Gram Panchayat"}}
                                @endif
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        @else
                            <div class="alert alert-danger">
                                <p>BID winner information not available</p>
                            </div>
                        @endif
                    </div>
                </div>
                            ...
                            <table class="table table-bordered hf">
                                ...
                                @foreach($data['uploadedDoc'] AS $doc)
                                    <tr>
                                        ...
                                        <td><a href="{{$imgUrl.$doc->attachment_path}}">Click to view</a></td>
                                    </tr>
                                @endforeach
                                @if(isset($data['settlementData']->final_report_path))
                                <tr>
                                    <td class="bold-text">Final Uploaded Comparitive Statement with signatures</td>
                                    <td><a href="{{$imgUrl.$data['settlementData']->final_report_path}}">Click to view</a></td>
                                </tr>
                                @endif
                                </tbody>
                            </table>
