...
@section('content')
    ...
    <div class="container-fluid" style=" padding-bottom: 40px; padding-top: 40px;">
        ...
        <div class="container">
           <div class="row">
               <h2 style="text-align: center;color: #6b133d; font-family:inherit; font-weight: 700">Own Source of Revenue (OSR) Non-Tax Revenue Sources</h2>
            ...
            @foreach($card_data as $cards)
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="card animated zoomIn">
                        ...
                        <div class="card-body">
                            <span class="number circle blinking" style="font-family: font-family: 'Fauna One', serif;">{{$cards['Total']}}/{{$cards['Settlement']}} Cr</span>
							
							<p style="font-size:12px; color:#333">*Total Revenue Collection/Total Settlement Amount: </p>
        ...
        <div class="row mt40">
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:10px">
                <ul class="nav nav-pills">
                    <li class="active"><a data-toggle="tab" href="#collection_table">Tabular View</a></li>
                    <li><a data-toggle="tab" href="#collection_graph">Graphical View</a></li>
                </ul>
            </div>
            <div class="tab-content">
                    ...
                    <div class="panel-heading1 gray-back" style="text-align: center">
                        <table class="table text-center data-header">
                            <tr class="data-header-head">
                                ...
                                <th class="text-center">Revenue Collection from Non-Tax Asset</th>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="dataTable1">
                                ...
                                <tr class="tr-row head-txt">
                                    ...
                                    <td>Revenue Collection from Non-Tax Asset (Cr.)</td>
                                    <td>Revenue Collection from Other Assets (Cr.)</td>
                                    <td>Total Revenue Collection (Cr.)</td>
                                    <td>Shared Amount Distributed to APs (Cr.)</td>
                                    <td>Shared Amount Distributed to GPs (Cr.)</td>
                                    <td>Shared Amount Received From APs (Cr.)</td>
                                    {{--<td>Shared Amount Received From GPs (Cr.)</td>--}}
                                    <td>Total Available Revenue (Cr.)</td>
                                ...
                                @foreach($zilas AS $list)
                                    <tr>
                                        ...
                                        <td>
                                            {{$dataCount['zpYrWiseRevenueList'][$list->id]['ap_share']}}
                                        </td>
                                        <td>
                                            {{$dataCount['zpYrWiseRevenueList'][$list->id]['gp_share']}}
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            {{$dataCount['zpYrWiseRevenueList'][$list->id]['tot_a_b']}}
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
                ...
                <div id="collection_graph" class="tab-pane fade">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="text-align: center">
                            Zilla Wise Revenue Collection for {{$fy_years}} (in Cr.)
                        </div>
                        <div class="panel-body">
                            <div id="canvas-holder" style="width:100%;">
          ...
          <div class="row mt40">
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading" style="text-align: center">
                        Settlement List (Zilla Wise) for {{$fy_years}}
                    </div>
                    <div class="panel-heading1 gray-back" style="text-align: center">
                        <table class="table text-center data-header">
                            <tr class="data-header-head">
                            ...
                            <tr class="data-header-value">
                                ...
                                <td>{{round($dataCount['totalStateCount']['settledPercent'],2)}}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="panel-body gray-back">
            ...
            <div class="col-md-6">
                <div class="panel panel-primary">
                    <div class="panel-heading" style="text-align: center">
                        List of Defaulters (Zilla Wise) for {{$fy_years}}
                    </div>
                    <div class="panel-heading1 gray-back" style="text-align: center">
                        <table class="table text-center data-header">
                            <tr class="data-header-head">
                            ...
                            <tr class="data-header-value">
                                ...
                                <td>{{round($dataCount['totalStateCount']['defaulterPercent'],2)}}</td>
                            </tr>
                        </table>
                    </div>
                    <div class="panel-body gray-back">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(isset($dataCount['zpYrWiseDefaulterCount'][$list->id]))
                                                <a href="#"  data-zfyyear="{{$max_osr_fy_year}}" data-zid="{{$list->id}}" data-zpname="{{$list->zila_parishad_name}}" class="listOfZPDefaulterModalViewC">
        ...
        <div class="row mt40">
            <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:10px">
                <ul class="nav nav-pills">
                    <li class="active"><a data-toggle="tab" href="#share_table">Tabular View</a></li>
                    <li><a data-toggle="tab" href="#share_graph">Graphical View</a></li>
                </ul>
            </div>
             <div class="tab-content">
                    <div id="share_table" class="tab-pane fade in active">
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading" style="text-align: center">
                                    Zilla Parishad Wise Share Distribution for {{$fy_years}}
                                </div>
                                <div class="panel-heading1 gray-back" style="text-align: center">
                                    <table class="table text-center data-header">
                                        <tr class="data-header-head" >
                    ...
                    <div id="share_graph" class="tab-pane fade">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading" style="text-align: center">
                                    Zilla Wise Share Distribution {{$fy_years}} (in Cr.)
                                </div>
                                <div class="panel-body">
                                    <div id="canvas-holder" style="width:100%;">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="dataTable5">
                                ...
                                <tr>
                                    ...
                                    <td>{{$yrWiseOtherAssetCount[$cards['id']]}}</td>
                                </tr>
                                @endforeach
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered table-striped" id="dataTable6">
                                ...
                                @foreach($card_data as $cards)
                                    <tr>
                                        <td>{{$cards['FY']}}</td>
                                        <td>
                                            <a href="#" data-zfyyear="{{$cards['id']}}" data-fyname="{{$cards['FY']}}" class="listOfTotalDefaulterYearWiseModalView">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="border-radius: 33px 0 0 0;">
                <div class="modal-header" style="background-color: #ff9000">
                    ...
                    <h4 style="color: #fff;font-family: 'Old Standard TT', serif;">Total Defaulter List for the Financial Year {{$fy_years}}</h4>
                </div>
    ...
    <!-- Model Total Defaulters Year Wise-->
    <div class="modal fade" id="listOfTotalDefaulterYearWiseModalView" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" style="border-radius: 33px 0 0 0;">
                <div class="modal-header" style="background-color: #ff9000">
                    <button type="button" class="btn bg-red modal-close" data-dismiss="modal" aria-hidden="true">
                    ...
                    <h4 style="color: #fff;font-family: 'Old Standard TT', serif;">Defaulter List for the Financial Year <span id="selectedfy"></span></h4>
                </div>
                <div class="modal-body">

                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="dataTable13" style="width:100%">
                            <thead>
        ...
        $(document).ready(function () {
            $('#dataTable1').DataTable({
                ...
                buttons: [
                    {
                        extend:    'excelHtml5',
                        title: 	   'Revenue Collection After Sharing (Zila Wise) for {{$fy_years}}',
            ...
            $('#dataTable2').DataTable({
                ...
                buttons: [
                    {
                        extend:    'excelHtml5',
                        title: 	   'Zilla Wise Share Distribution for {{$fy_years}}',
                        text:      'Export to Excel <i class="fa fa-file-excel-o" style="font-size: 15px"></i>',
                        titleAttr: 'Excel'
                    }
                ]
            ...
            $('#dataTable3').DataTable({
                ...
                buttons: [
                    {
                        extend:    'excelHtml5',
                        title:     'List of Defaulters (Zilla Wise) for {{$fy_years}}',
                        text:      'Export to Excel <i class="fa fa-file-excel-o" style="font-size: 15px"></i>',
                        titleAttr: 'Excel'
                    }
                ]
            ...
            $('#dataTable4').DataTable({
                ...
                buttons: [
                    {
                        extend:    'excelHtml5',
                        title:     'Settlement List (Zilla Wise) for {{$fy_years}}',
                        title:     'Settlement List (Zilla Wise) for FY-2019-2020',
                        text:      'Export to Excel <i class="fa fa-file-excel-o" style="font-size: 15px"></i>',
                        titleAttr: 'Excel'
                    }
                ]
...
//                borderWidth: 1,
                data: [
                    @foreach($card_data as $cards)
                    {{$yrWiseOtherAssetCount[$cards['id']]}},
                    @endforeach
                ]
            }]
        ...
        window.myBar = new Chart(ctxZilaWiseShares, {
            ...
            options: {
                title: {
                    display: true,
                    text: 'Zilla Wise Share Distribution'
                },
                tooltips: {
                    mode: 'index',
                    intersect: false
        ...
        window.myBar = new Chart(ctx4, {
            ...
            options: {
                title: {
                    display: true,
                    text: 'Zilla Wise Revenue Collection (Graph View)'
                },
                tooltips: {
                    mode: 'index',
                    intersect: false
                    ...
                    if (data.msgType == true) {
                        ...
                        $('#dataTable11').DataTable( {
                            ...
                            buttons: [
                                {
                                    extend:    'excelHtml5',
                                    title:     'Total Defaulter List for the Financial Year {{$fy_years}}',
                                    text:      'Export to Excel <i class="fa fa-file-excel-o" style="font-size: 15px"></i>',
                                    titleAttr: 'Excel'
                                }
                            ],
        ...
        //        List of Defaulter Total Year Wise Model
        $('.listOfTotalDefaulterYearWiseModalView').on('click', function(e){
            e.preventDefault();
            ...
            $('#listOfTotalDefaulterYearWiseModalView').modal('hide');

            var zfyyear = $(this).data('zfyyear');
            var fyname = $(this).data('fyname');
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{route('admin.Osr.dashboard.listOfTotalDefaulterYearWise')}}',
                dataType: "json",
                data: {zfyyear : zfyyear},
                success: function (data) {
                    if (data.msgType == true) {
                        ...
                        $('#dataTable13').DataTable( {
                            ...
                            buttons: [
                                {
                                    extend:    'excelHtml5',
                                    title:     'Defaulter List for the Financial Year '+fyname+'',
                                    text:      'Export to Excel <i class="fa fa-file-excel-o" style="font-size: 15px"></i>',
                                    titleAttr: 'Excel'
                                }
                            ],
                        ...
                        $('#selectedfy').text(fyname);

                        $('#listOfTotalDefaulterYearWiseModalView').modal('show');
