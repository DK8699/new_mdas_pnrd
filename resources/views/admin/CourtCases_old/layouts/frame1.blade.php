        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                  ...
                  <li class="{{ (request()->is('admin/courtCases/listCourtCase')) ? 'active' : '' }}"><a href="{{route('admin.courtCases.listCourtCase')}}">List Court Cases</a></li>
...
<div class="f-strip">
    <div class="row">
        <div class="col-md-12">Copyright © 2019, SIPRD.All rights reserved. Designed, Developed &amp; Maintained by <a href="https://gratiatechnology.com/">Gratia Technology</a></div>
    </div>
</div>
