...
<style>
    ...
    .back {
        webkit-box-shadow: 1px 5px 8px 4px rgba(209,209,209,1);
        -moz-box-shadow: 1px 5px 8px 4px rgba(209,209,209,1);
        box-shadow: 1px 5px 8px 4px rgba(209,209,209,1);
        background-color:rgba(255, 255, 255, 0.75);
        padding:15px 15px;margin:5px 5px 55px 5px;
        min-height:555px;
    }
    h3 {
        font-weight:bold;
...
<script>
    ...
    /********************************Nature of Cases Vs Cases Status*******************************/
        am4core.ready(function() {
            ...
            // Create chart instance
            var chart = am4core.create("nature_of_case_vs_case_status", am4charts.XYChart);
            ...
            categoryAxis.dataFields.category = "nature";
            categoryAxis.title.text = "Nature of Case";
            categoryAxis.renderer.grid.template.opacity = 0;

            var valueAxis = chart.xAxes.push(new am4charts.ValueAxis());
            valueAxis.title.text = "Court Cases Status";
            valueAxis.min = 0;
            ...
            series.dataFields.categoryY = "nature";
            series.stacked = true;
            series.name = name;
            ...
            createSeries("Ongoing Case", "Ongoing Case");
            createSeries("Closed Case", "Closed Case");
            createSeries("Disposed Case", "Disposed Case");
    ...
    /********************************Cases Status*******************************/
        am4core.ready(function() {
            ...
            // Create chart instance
            var chart = am4core.create("case_status", am4charts.PieChart);
