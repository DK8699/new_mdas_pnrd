          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                  <li class="{{ (request()->is('dashboard')) ? 'active' : '' }}"><a href="{{route('dashboard')}}"> <i class="fa fa-home"></i> Home</a></li>
                  <li class="{{ (request()->is('panchayat_profile')) ? 'active' : '' }}"><a href="{{route('panchayat_profile')}}"> <i class="fa fa-building"></i> Panchayat Profile</a></li>
                  @if(request()->is('user/*'))
                      <li class="{{ (request()->is('user/user_management')) ? 'active' : '' }}"><a href="{{route('user.user_management')}}">User Management</a></li>
                  @endif
              </ul>
...
<div class="f-strip">
    <div class="row">
        <div class="col-md-12" style="text-align: center">
            Copyright © <script>document.write(new Date().getFullYear());</script> , SIPRD. All rights reserved. Designed, Developed &amp; Maintained by <a href="https://gratiatechnology.com/" target="_blank">Gratia Technology</a>
        </div>
    </div>
</div>
