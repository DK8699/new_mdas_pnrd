        ...
        <div class="navbar">
            ...
            <nav>
                ...
                <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                    ...
                    <li class="{{ (request()->is('Uc/dashboard')) ? 'active' : '' }}">
                        <a href="{{route('Uc.dashboard')}}">
                            <i class="fa fa-tachometer" aria-hidden="true"></i>
                            <span class="title">Dashboard</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('Uc/ucAddProject')) ? 'active' : '' }} {{ (request()->is('Uc/ucViewProject')) ? 'active' : '' }} {{ (request()->is('Uc/addProjectYears')) ? 'active' : '' }} {{ (request()->is('Uc/viewProjectYears')) ? 'active' : '' }}">
                        <a class="" href="javascript:;">
                           <i class="fa fa-tasks" aria-hidden="true"></i>
                            <span class="title">Project</span>
                        </a>
                        <ul>
                            <li class="{{ (request()->is('Uc/ucViewProject')) ? 'active' : '' }}">
                                <a href="{{route('Uc.ucViewProject')}}">View Project</a>
                            </li>
                            <li class="{{ (request()->is('Uc/viewProjectYears')) ? 'active' : '' }}">
                                <a href="{{route('Uc.viewProjectYears')}}">View Years</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ (request()->is('Uc/addEntities')) ? 'active' : '' }} {{ (request()->is('Uc/viewEntities')) ? 'active' : '' }}">
                        <a href="javascript:;">
                            <i class="fa fa-cubes" aria-hidden="true"></i>
                            <span class="title">Components-Entities</span>
                        </a>
                        <ul>
                            <li class="{{ (request()->is('Uc/addComponent')) ? 'active' : '' }}">
                                <a href="{{ route('Uc.addComponent') }}">View Components</a>
                            </li>
                            <li class="{{ (request()->is('Uc/viewEntities')) ? 'active' : '' }}">
                                <a href="{{ route('Uc.viewEntities') }}">View Entities</a>
                            </li>
                        </ul>
                    </li>
                    <li class="last  {{ (request()->is('Uc/addEditComponentDetails')) ? 'active' : '' }}  {{ (request()->is('Uc/viewComponentDetails')) ? 'active' : '' }}">
                        <a href="javascript:;">
                            <i class="fa fa-cubes" aria-hidden="true"></i>
                            <span class="title">Expenditure-UC</span>
                        </a>
                        <ul>
                            <li class="{{ (request()->is('Uc/addEditComponentDetails')) ? 'active' : '' }}">
                                <a href="{{ route('Uc.addEditComponentDetails') }}">Add / Edit Expenditure-UC</a>
                            </li>
                            <li class="{{ (request()->is('Uc/viewComponentDetails')) ? 'active' : '' }}">
                                <a href="{{ route('Uc.viewComponentDetails') }}">View Expenditure-UC</a>
                            </li>
                        </ul>
                    </li>
