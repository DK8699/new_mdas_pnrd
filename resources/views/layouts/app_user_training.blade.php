    ...
    <div class="container-fluid" style="border-top: 1px solid rgba(143, 58, 58, 0.26);background: #11123482;">
        <div class="navbar">
            ...
            <nav>
				...
				<li class="{{ (request()->is('training/dashboard')) ? 'active' : '' }}">
                        <a href="{{route('training.dashboard')}}">
                            <i class="fa fa-tachometer" aria-hidden="true"></i>
                            <span class="title">Dashboard</span>
                        </a>
                    </li>
				<li class="{{ (request()->is('training/training_schedule_list')) ? 'active' : '' }}">
                        <a class="" href="{{route('training.training_schedule_list')}}">
                           <i class="fa fa-tasks" aria-hidden="true"></i>
                            <span class="title">Training Schedule</span>
                        </a>
                       <!-- <ul>
                           <li class="{{ (request()->is('')) ? 'active' : '' }}">
                                <a href="">Schedule Entry</a>
                           </li>
                        </ul>-->
                    </li>
                    <!-- For mobile screen -->
