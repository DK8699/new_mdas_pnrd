    ...
    <div class="container-fluid" style="border-top: 1px solid rgba(143, 58, 58, 0.26);background: #11123482;">
        <div class="navbar">
            ...
            <nav>
				...
				<li class="{{ (request()->is('admin/Grievance/dashboard')) ? 'active' : '' }}">
                        <a href="{{route('admin.Grievance.dashboard')}}">
                            <i class="fa fa-tachometer" aria-hidden="true"></i>
                            <span class="title">Dashboard</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('admin/Grievance/Media/entry')) ? 'active' : '' }} {{ (request()->is('admin/Grievance/Media/action_panel')) ? 'active' : '' }}">
                        <a class="" href="javascript:;">
                           <i class="fa fa-tasks" aria-hidden="true"></i>
                            <span class="title">Media Grievance</span>
                        </a>
                        <ul>
                           <li class="{{ (request()->is('admin/Grievance/Media/entry')) ? 'active' : '' }}">
                                <a href="{{route('admin.Grievance.media.entry')}}">Lodge Grievance</a>
                           </li>
					   <li class="{{ (request()->is('admin/Grievance/Media/action_panel')) ? 'active' : '' }}">
                                <a href="{{route('admin.Grievance.media.action_panel')}}">Action</a>
                           </li>
                        </ul>
                    </li>
				 <li class="{{ (request()->is('admin/Grievance/addRecipients')) ? 'active' : '' }} {{ (request()->is('admin/Grievance/viewRecipients')) ? 'active' : '' }}">
                        <a class="" href="javascript:;">
                           <i class="fa fa-tasks" aria-hidden="true"></i>
                            <span class="title">Recipients</span>
                        </a>
                        <ul>
                           <li class="{{ (request()->is('admin/Grievance/addRecipients')) ? 'active' : '' }}">
                                <a href="{{route('admin.Grievance.addRecipients')}}">Add Recipients</a>
                           </li>
					   <li class="{{ (request()->is('admin/Grievance/viewRecipients')) ? 'active' : '' }}">
                                <a href="{{route('admin.Grievance.viewRecipients')}}">View</a>
                           </li>
                        </ul>
                    </li>
				<li class="{{ (request()->is('admin/Grievance/Individual/griev_entry')) ? 'active' : '' }} {{ (request()->is('admin/Grievance/Individual/individual_griev_list')) ? 'active' : '' }}">
                        <a class="" href="javascript:;">
                           <i class="fa fa-tasks" aria-hidden="true"></i>
                            <span class="title">Individual Grievance</span>
                        </a>
                        <ul>
                           <li class="{{ (request()->is('admin/Grievance/Individual/griev_entry')) ? 'active' : '' }}">
                                <a href="{{route('admin.Grievance.individual_griev_entry')}}">Lodge Grievance</a>
                           </li>
					   <li class="{{ (request()->is('admin/Grievance/Individual/individual_griev_list')) ? 'active' : '' }}">
                                <a href="{{route('admin.Grievance.Individual.individual_griev_list')}}">Action</a>
                           </li>
                        </ul>
                    </li>
