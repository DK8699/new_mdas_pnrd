...
<head>
    ...
    <!--Gallery Viewer-->
    <link rel="stylesheet" href="{{ asset('mdas_assets/index/assets/fancybox-master/dist/jquery.fancybox.min.css') }}"
        ...
        <div class="row flag-header">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <ul class="list-inline pull-left">
                    <li class="indianflag"
                        style="padding: 4px;border-right: 1px solid #8080808f;
                font-size: 0.929em;color:#fff">
                        <img src="{{ asset('mdas_assets/images/indianflag.jpg') }}" alt="India Flag" height="15"
                            width="22" />
                        Government of India
                    </li>
                </ul>
                ...
                <ul class="list-inline pull-right">
                    ...
                    <li class="font-limit">
                        <a id="a0" style="text-decoration: none" href="#" data-toggle="tooltip"
                            data-placement="bottom" title="Decrease font size">A-</a>
                        <a id="a1" style="text-decoration: none" href="#" data-toggle="tooltip"
                            data-placement="bottom" title="Original font size">A</a>
                        <a id="a2" style="text-decoration: none" href="#" data-toggle="tooltip"
                            data-placement="bottom" title="Increase font size">A+</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row" style="border: 1px solid rgba(143, 58, 58, 0.26); background: #11123482;">
                ...
                <nav>
                    <a class="navbar-brand" href="#" style="">
                        <img id="main-logo" src="{{ asset('mdas_assets/index/assets/img/logos/mdas.png') }}"
                            alt="logo" style="width:135.55px">
                    </a>
                    <!-- Menu Toggle btn-->
                    ...
                    <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul>
                                        <li><a href="{{ route('osr_asset_settlement') }}">Category Wise Assets</a>
                                        </li>
                        ...
                        <!-- For mobile screen -->
                        <li class="login-xs"><a href="{{ route('login') }}" style="background: #ed0303; "><span
                ...
                <span class="pull-right login-md" style="background: #ed0303; padding: 19px; margin-right: 9px;"><a
                        href="{{ route('login') }}" style="color:#fff"><span
