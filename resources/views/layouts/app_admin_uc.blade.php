        ...
        <div class="navbar">
            ...
            <nav>
                ...
                <ul id="respMenu" class="ace-responsive-menu" data-menu-style="horizontal">
                    ...
                    <li class="{{ (request()->is('admin/Uc/dashboard')) ? 'active' : '' }}">
                        <a href="{{route('admin.Uc.dashboard')}}">
                            <i class="fa fa-tachometer" aria-hidden="true"></i>
                            <span class="title">Dashboard</span>
                        </a>
                    </li>
                    <li class="{{ (request()->is('admin/Uc/ucAddProject')) ? 'active' : '' }} {{ (request()->is('admin/Uc/ucViewProject')) ? 'active' : '' }} {{ (request()->is('admin/Uc/addProjectYears')) ? 'active' : '' }} {{ (request()->is('admin/Uc/viewProjectYears')) ? 'active' : '' }}">
                        <a class="" href="javascript:;">
                           <i class="fa fa-tasks" aria-hidden="true"></i>
                            <span class="title">Project</span>
                        </a>
                        <ul>
                            <li class="{{ (request()->is('admin/Uc/ucAddProject')) ? 'active' : '' }}">
                                <a href="{{route('admin.Uc.ucAddProject')}}">Add Project</a>
                            </li>
                            <li class="{{ (request()->is('admin/Uc/ucViewProject')) ? 'active' : '' }}">
                                <a href="{{route('admin.Uc.ucViewProject')}}">View Project</a>
                            </li>
                            <li class="{{ (request()->is('admin/Uc/addProjectYears')) ? 'active' : '' }}">
                                <a href="{{route('admin.Uc.addProjectYears')}}">Add Years</a>
                            </li>
                            <li class="{{ (request()->is('admin/Uc/viewProjectYears')) ? 'active' : '' }}">
                                <a href="{{route('admin.Uc.viewProjectYears')}}">View Years</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ (request()->is('admin/Uc/addEntities')) ? 'active' : '' }} {{ (request()->is('admin/Uc/viewEntities')) ? 'active' : '' }}">
                        <a href="javascript:;">
                            <i class="fa fa-cubes" aria-hidden="true"></i>
                            <span class="title">Components-Entities</span>
                        </a>
                        <ul>
                            <li class="{{ (request()->is('admin/Uc/addComponent')) ? 'active' : '' }}">
                                <a href="{{ route('admin.Uc.addComponent') }}">Add / View Components</a>
                            </li>
                            <li class="{{ (request()->is('admin/Uc/addEntities')) ? 'active' : '' }}">
                                <a href="{{ route('admin.Uc.addEntities') }}">Add Entities</a>
                            </li>
                            <li class="{{ (request()->is('admin/Uc/viewEntities')) ? 'active' : '' }}">
                                <a href="{{ route('admin.Uc.viewEntities') }}">View Entities</a>
                            </li>
                        </ul>
                    </li>
                    <li class="last  {{ (request()->is('admin/Uc/addEditComponentDetails')) ? 'active' : '' }}  {{ (request()->is('admin/Uc/viewComponentDetails')) ? 'active' : '' }}">
                        <a href="javascript:;">
                            <i class="fa fa-cubes" aria-hidden="true"></i>
                            <span class="title">Expenditure-UC</span>
                        </a>
                        <ul>
                            <li class="{{ (request()->is('admin/Uc/addEditComponentDetails')) ? 'active' : '' }}">
                                <a href="{{ route('admin.Uc.addEditComponentDetails') }}">Add / Edit Expenditure-UC</a>
                            </li>
                            <li class="{{ (request()->is('admin/Uc/viewComponentDetails')) ? 'active' : '' }}">
                                <a href="{{ route('admin.Uc.viewComponentDetails') }}">View Expenditure-UC</a>
                            </li>
                        </ul>
                    </li>
                    <li class="{{ (request()->is('admin/Uc/componentWiseReports')) ? 'active' : '' }}">
                        <a href="{{route('admin.Uc.componentWiseReports')}}">
                    ...
                    <li class="logout">
                        ...
                        <ul>
                            <li>
                                <a href="{{route('admin.UsersManagement.profile')}}"><i class="fa fa-user"></i> My Profile</a>
                            </li>
                            <li>
