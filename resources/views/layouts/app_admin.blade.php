        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav">
                  <li class="{{ (request()->is('admin/dashboard')) ? 'active' : '' }}"><a href="{{route('admin.dashboard')}}">Home</a></li>
                  <li class="{{ (request()->is('admin/Osr/*')) ? 'active' : '' }}"><a  href="{{route('admin.Osr.osr_dashboard')}}">OSR Non-Tax Sources</a></li>
                  <li class="{{ (request()->is('admin/UsersManagement/*')) ? 'active' : '' }}"><a href="{{route('admin.UsersManagement.user_dashboard')}}">User Management</a></li>
				  <li class="{{ (request()->is('admin/Shortlist/Osr/Asset/*')) ? 'active' : '' }}"><a href="{{route('admin.Osr.asset.asset_status')}}">Asset Status</a></li>
				  <li class="{{ (request()->is('admin/Asset/Osr/*')) ? 'active' : '' }}"><a href="{{route('admin.Asset.Osr.osrAssetsReport')}}">Asset Report</a></li>
			  </ul>
