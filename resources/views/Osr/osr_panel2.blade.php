            ...
            @elseif(Auth::user()->mdas_master_role_id==3) {{--AP Admin------------------------------------------------------}}
                <div class="tab-content">
                    <div id="settlement" class="tab-pane fade in active">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/ap_asset_settlement_percent')}}/{{encrypt($data['fy_id'])}}}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Settlement Percentage(AP)</p>
                                        <div class="progress mt40">
                                            <div class="progress-bar progress-bar-primary progress-bar-striped active" role="progressbar"
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/gp_list_asset_settlement_percent')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Settlement Percentage(GP)</p>
                                        <div class="progress mt40">
                                            <div class="progress-bar progress-bar-primary progress-bar-striped active" role="progressbar"
                    ...
                    <div id="collection" class="tab-pane fade">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/ap_asset_collection')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Collection(AP)</p>
                                        <div class="card-body">
                                            <table class="table">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/gp_list_asset_collection')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Collection(GP)</p>
                                        <div class="card-body">
                                            <table class="table">
                    ...
                    <div id="defaulter" class="tab-pane fade">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/ap_asset_defaulter')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Defaulter(AP)</p>
                                        <div class="card-body">
                                            <table class="table">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/gp_list_asset_defaulter')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Defaulter(GP)</p>
                                        <div class="card-body">
                                            <table class="table">
                    ...
                    <div id="share" class="tab-pane fade">
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/ap_asset_share')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Share Distributed By AP</p>
                                        <table class="table">
                                            <tr>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/ap/gp_list_asset_share')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Share Distributed By GP</p>
                                        <table class="table">
                                            <tr>
            ...
            @elseif(Auth::user()->mdas_master_role_id==4) {{--GP Admin------------------------------------------------------}}
                <div class="tab-content">
                    <div id="settlement" class="tab-pane fade in active">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/gp/gp_asset_settlement_percent')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Settlement Percentage(GP)</p>
                                        <div class="progress mt40">
                                            <div class="progress-bar progress-bar-primary progress-bar-striped active" role="progressbar"
                    ...
                    <div id="collection" class="tab-pane fade">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/gp/gp_asset_collection')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Collection(GP)</p>
                                        <div class="card-body">
                                            <table class="table">
                    ...
                    <div id="defaulter" class="tab-pane fade">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/gp/gp_asset_defaulter')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Defaulter(GP)</p>
                                        <div class="card-body">
                                            <table class="table">
                    ...
                    <div id="share" class="tab-pane fade">
                        <div class="col-md-4 col-sm-4 col-xs-12">
                            <div class="cardd animated zoomIn">
                                <a href="{{url('osr/non_tax/asset/gp/gp_asset_share')}}/{{encrypt($data['fy_id'])}}" style="text-decoration:none; color:#333">
                                    <div class="card-body" style="background:#e7d6cf;">
                                        <p style="background:#c8a186;">Share Distributed By GP</p>
                                        <table class="table">
                                            <tr>
