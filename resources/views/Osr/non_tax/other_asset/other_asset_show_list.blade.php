...
@section('content')
    ...
    <div class="container mb40">
        <div class="row mt40">
            <form action="{{route('osr.non_tax.other_asset_show_list')}}" method="post">
                @csrf
                <div class="col-md-3 col-sm-4 col-xs-12">
                   <div class="form-group">
                       ...
                       <select class="form-control" name="cat_id" id="cat_id" required>
                           ...
                           @foreach($data['catList'] AS $li)
                               <option value="{{$li->id}}" @if($data['cat_id']==$li->id)selected="selected"@endif>{{$li->cat_name}}</option>
                           @endforeach
                       </select>
                   </div>
                </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable1">
                        ...
                        <tbody>
                        @php $i=1; @endphp
                        @foreach($data['otherAssetList'] AS $li)
                            <tr>
                                <td>{{$i}}</td>
                                <td>
