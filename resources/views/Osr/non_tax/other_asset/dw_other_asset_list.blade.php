                    ...
                    <table class="table table-bordered" id="dataTable1">
                        ...
                        @foreach($assetList AS $li)
                            <tr>
                                ...
                                <td>{{$li->other_asset_listing_date}}</td>
                                <td>{{$li->managed_by}}</td>
                                <td>{{$li->asset_add}}</td>
                                <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="list_date" id="list_date" placeholder=""/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            @elseif(Auth::user()->mdas_master_role_id==4)
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="gp_id" id="gp_id">
                                            <option value="">---Select---</option>
                                            <option value="{{$gpData->gram_panchyat_id}}">{{$gpData->gram_panchayat_name}}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-4 col-xs-12">
    ...
    <div class="modal fade" id="edit_modal">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="#" method="POST" id="editOtherAssetForm" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label>Asset Listing Date <strong>*</strong></label>
                                    <input type="text" class="form-control" name="ed_list_date" id="ed_list_date" placeholder=""/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label>Address</label>
                                    <textarea class="form-control" rows="2" name="ed_asset_add" id="ed_asset_add"></textarea>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label>Remarks if any</label>
                                    <textarea class="form-control" rows="2" name="ed_remarks" id="ed_remarks"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
@section('custom_js')
    ...
    <script type="application/javascript">
        ...
        $('#list_date').Zebra_DatePicker();
        $('#ed_list_date').Zebra_DatePicker();
        ...
        $('.editModalBtn').on('click', function(e){
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{route('osr.non_tax.dw_other_asset.getById')}}',
                dataType: "json",
                ...
                success: function (data) {
                    if (data.msgType == true) {
                        ...
                        $('#aid').val(data.data.otherAssetData.id);

                        $('#ed_shared_with').val(data.data.otherAssetData.shared_with);
                        ...
                        $('#ed_gp_id').val(data.data.otherAssetData.gram_panchayat_id);
                        $('#ed_v_id').val(data.data.otherAssetData.village_id);
                        $('#ed_asset_name').val(data.data.otherAssetData.other_asset_name);
                        $('#ed_list_date').val(data.data.otherAssetData.other_asset_listing_date);
                        $('#ed_asset_add').val(data.data.otherAssetData.asset_add);
                        $('#ed_remarks').val(data.data.otherAssetData.remarks);
                        $('#ed_zp_id').val(data.data.otherAssetData.zila_id);
                        $('#ed_ap_id').val(data.data.otherAssetData.anchalik_id);
        ...
        $('#editOtherAssetForm').on('submit', function(e){
            e.preventDefault();

            if($('#editOtherAssetForm').valid()){
                $('.page-loader-wrapper').fadeIn();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    ...
                    type: "POST",
                    url: '{{route('osr.non_tax.dw_other_asset.edit')}}',
                    dataType: "json",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
