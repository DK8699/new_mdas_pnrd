    ...
    <div class="container mb40">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>@if($acceptedBidderData)<span class="money_txt">{{$acceptedBidderData->bidding_amt}}</span>@else{{"NA"}}@endif
                                        </td>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            @endif
                                            <button type="button" data-toggle="modal" data-target="#addGap">Add Collection</button>
                                        </td>
                                        ...
                                        @if($settlementData && $data['finalRecordData'])
                                            <td>
                                                <table class="table table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if($instalment->id==1){{$firstInstallmentLastDate}}@elseif($instalment->id==2){{$secondInstallmentLastDate}}@else{{$thirdInstallmentLastDate}}@endif
                                                        </td>
                                                        <td>
                                                            @if(isset($data['subInsData'][$instalment->id]['data']->payment_mode))
                                                                @php $paymentMode= $data['subInsData'][$instalment->id]['data']->payment_mode; @endphp
                                                                @if($paymentMode=="P")
                                                                    {{"Partial Payment"}}
                                                                @elseif($paymentMode=="F")
                                                                    {{"Full Payment"}}
                                                                @endif
                                                            @endif
                                                        </td>
                                            ...
                                            <td>
                                                <table class="table table-bordered">
                                                    ...
                                                    {{-------------------DEFAULTER SECTION----------------------------}}
                                                    @if($data['finalRecordData']->instalment_no > 0)
                                                    <tr class="bg-primary">
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            @if($data['finalRecordData']->defaulter_status==0)
                                                                <button type="button" data-toggle="modal" data-target="#defaulter_modal">Mark As Defaulter</button>
                                                            @else
                                                                <button type="button" class="bg-success">
                                                                    <i class="fa fa-check"></i>
                                                                    Marked As Defaulter
                            ...
                            <div class="row" id="amt_receipt">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="ins_receipt_date" id="ins_receipt_date" class="form-control date"/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="form-group">
                                        <label>Amount receipt <strong>*</strong></label>
                                        <input type="text" name="ins_receipt_amount" id="ins_receipt_amount" class="form-control money"/>
                                    </div>
                                </div>
                            </div>
        ...
        @section('custom_js')
            ...
            <script type="application/javascript">
                        ...
                        datasets: [
                            {
                                ...
                                data: [
                                    ...
                                    @if($data['finalRecordData'] && $data['finalRecordData']->forfeited_emd_sharing_status==1){{$data['finalRecordData']->total_forfeited_emd_amt}}@else{{0}}@endif,
                ...
                $("input[name='ins_payment']").on('change', function(e){
                    e.preventDefault();
                ...
                function call_rebate(payment, amt, req_amt){
                    if(payment=="F" && amt < req_amt){
                        $('#rebate_section').remove();

                        var rebate_amt= indianRupeeFormatterText({{$data['finalRecordData']->settlement_amt-$data['finalRecordData']->tot_ins_collected_amt}} - amt);

                        if(amt) {

                            $('#amt_receipt').after('<div class="row" id="rebate_section">' +
                                '<div class="col-md-12 col-sm-12 col-xs-12">' +
                                '<div class="form-group">' +
                                ...
                                '<textarea type="text" name="rebate_remarks" id="rebate_remarks" class="form-control"></textarea>' +
                                '</div>' +
                                '</div>' +
                                '<div class="col-md-12 col-sm-12 col-xs-12">' +
                                '<div class="form-group">' +
                                '<label>Documents of rebate</label>' +
                                '<input type="file" name="rebate_doc" id="rebate_doc" class="form-control"/>' +
                                '</div>' +
                                '</div>' +
                                '</div>');
                        }
