...
<body style="font-size: 11px;">
    ...
    <table cellpadding="0" cellspacing="0" class="head">
        ...
        <tr>
            <td style="border: 0px;">
                <p style="font-size:20px;" class="txt-upper">Comparative BID Report (Non Tax Revenue Source)</p>
                <p style="font-size:14px;font-weight: 500">For the financial year : {{$osrFyYear->fy_name}}</p>
                <p class="txt-upper" style="font-size:14px;font-weight: 500">Asset Name: {{$assetData->asset_name}}</p>
            </td>
        </tr>
    </table>
    ...
    <h1 style="font-weight: 500">BID Summary</h1>
    ...
    <table cellspacing="0" class="table" style="margin-top:20px">
        ...
        <tr>
            ...
            <td><p class="label">Forfeited EMD</p></td>
    ...
    <table cellspacing="0" class="table" style="margin-top:20px">
        ...
        <tr>
            <td><p class="label">Security Deposited</p></td>
            <td colspan="3"><p class="txt-upper money_txt">{{$settlementData->security_deposit}}</p></td>
        </tr>
    </table>
    ...
    <table cellspacing="0" class="table1" style="margin-top:20px;">
        <tr style="background-color: deepskyblue">
            ...
            <td><p class="label">Earnest Deposit</p></td>
        ...
        @foreach($bidderDetail AS $bidder)
            <tr @if($bidder->bidder_status==1) style="background-color:lightgreen" @endif>
                ...
                <td style="width:13%"><p class="money_txt">Rs. {{$bidder->ernest_amt}}</p></td>
                <td style="width:9%">
                ...
                <td style="width:30%">
                    @if($bidder->bidder_status==0)
                        @if($bidder->osr_master_bidder_remark_id)
                            {{$bidder->remark}}
                        @endif
                    @endif
                </td>
    ...
    ******************************************************FOR OFFICE USE ONLY*****************************************************
    ...
    <table class="table2" style="margin-top:15px">
            <tr>
                ...
                <td colspan="2">
                    <p>...............................................................................</p>
                    <h3 style="text-align:center">(Signature of Chief Accounts Officer)</h3>
                </td>
                <td colspan="2">
                    <p>...............................................................................</p>
    ...
    <table class="table2" style="margin-top:15px">
            <tr>
                ...
                <td colspan="2">
                    <p>...............................................................................</p>
                    <h3 style="text-align:center">(Signature of BDO)</h3>
                </td>
                <td colspan="2">
                    <p>...............................................................................</p>
