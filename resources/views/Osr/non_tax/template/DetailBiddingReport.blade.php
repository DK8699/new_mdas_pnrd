...
<table cellpadding="0" cellspacing="0" class="head">
    ...
    <tr>
        <td style="border: 0px;">
            <p style="font-size:20px;" class="txt-upper">Overall BID Report (Non Tax Revenue Source)</p>
...
<table cellspacing="0" class="table" style="margin-top:20px">
 ...
 <h1 style="font-weight: 500">Bidding Summary</h1>
    ...
    <h1 style="font-weight: 500">Bidders Detail</h1>
