...
@section('content')
    ...
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li><a href="{{url('osr/non_tax/dw_asset_list')}}{{"/"}}{{base64_encode(base64_encode($branchData->id))}}">{{$branchData->branch_name}}</a></li>
    ...
    <div class="container mb40">
        ...
        <div class="panel panel-primary bidder-panel" style="@if($generalDetail)@if($generalDetail->stage==1){{"display:block"}}@else{{"display:none"}}@endif @else{{"display:none"}} @endif">
                            ...
                            <div class="table-responsive">
                                <form action="#" method="POST">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>{{$bidder->b_f_name." ".$bidder->b_m_name." ".$bidder->b_l_name}} ({{$bidder->gender_name}})</th>
                                        ...
                                        <tr class="bg-info">
                                            ...
                                            <th>Earnest Deposited</th>
                                            <th>Bidding Status</th>
                                            <th>Remarks</th>
                                        </tr>
                                        <tr>
                                            <th class="money_txt">{{$bidder->bidding_amt}}</th>
                                            <th class=""><span class="money_txt">{{$bidder->ernest_amt}}</span>
                                                         <span class="">/</span>
                                            </th>
                                            <td>
            ...
            <div class="panel-footer">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <button type="button" class="btn btn-primary" id="bidderPrevious" data-aid="{{$assetData->id}}" data-fy="{{$osrFyYear->id}}">
                            <i class="fa fa-arrow-left"></i>
                            PREVIOUS
                        </button>

                        <button type="submit" class="btn btn-primary pull-right" id="bidderEntry" data-aid="{{$assetData->id}}" data-fy="{{$osrFyYear->id}}">
                            <i class="fa fa-send"></i>
                            SAVE &amp; NEXT
                        </button>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <form action="#" method="POST" id="attachmentForm_{{$doc->id}}" style="@if(isset($uploadedDoc[$doc->id])) display:none @endif">
                                    ...
                                    <input type="hidden" name="asset_id" value="{{$assetData->id}}"/>
                                    <input type="hidden" name="fy_yr_id" value="{{$osrFyYear->id}}"/>

                                    <input type="file" class="form-control" name="attachment"/>
                                    <button type="submit" class="btn btn-primary btn-xs" id="upload_attach_{{$doc->id}}">
                                        <i class="fa fa-upload"></i>
                                        Upload
                                    </button>
                                    @if(isset($uploadedDoc[$doc->id]))
                                        <button type="button" class="btn btn-danger btn-xs cancel_attachment" id="cancel_attach_{{$doc->id}}" data-doc_id="{{$doc->id}}">
                                            Cancel
                                        </button>
                                    @endif
                                </form>
        ...
        <div class="panel panel-primary final-panel" style="@if($generalDetail)@if($generalDetail->stage==3){{"display:block"}}@else{{"display:none"}}@endif @else{{"display:none"}}@endif">
            ...
            <div class="panel-body">
                <div class="row">
                                ...
                                <div class="form-group">
                                   @if(isset($settlementData->final_report_path))
                                    <div class="alert alert-success" role="alert">
                                        ...
                                        Successfully uploaded the final signed report.
                                    </div>
                                   @else
                                    <div class="alert alert-danger" role="alert">
                                        <img src="{{asset('mdas_assets/images/unchecked.gif')}}" style="width:40px" alt="Checked Image"/>
                                        Upload the signed final report
                                    </div>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <a href="{{url('osr/non_tax/dw_asset/comparative/download')}}{{"/"}}{{base64_encode(base64_encode(base64_encode($assetData->id)))}}{{"/"}}{{base64_encode(base64_encode(base64_encode($osrFyYear->id)))}}" class="btn btn-primary btn-block">
                            <i class="fa fa-download"></i>
                            Comparitive Report
                        </a>
                    </div>
                   <div class="col-md-12 col-sm-12 col-xs-12 mt10">
                        <a href="{{url('osr/non_tax/dw_asset/DetailBidding/download')}}{{"/"}}{{base64_encode(base64_encode(base64_encode($assetData->id)))}}{{"/"}}{{base64_encode(base64_encode(base64_encode($osrFyYear->id)))}}" class="btn btn-primary btn-block">
                            <i class="fa fa-download"></i>
                           Download Report
                        </a>
                    </div>
            ...
            <div class="modal-content">
                ...
                {{--<div class="panel-heading panel-search" style="background-color: #f5f5f5;border-radius: 1px">
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-6">
                            <input type="text" class="form-control" name="search_data" id="search_data" placeholder="Enter PAN Number..."/>
                        </div>
                        <div class="col-md-6 col-sm-6 col-xs-6">
                ...
                <form action="" method="POST" id="addBidderForm" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <input type="hidden" name="b_asset_entry_id" id="b_asset_entry_id" value="{{$assetData->id}}"/>
                                <input type="hidden" name="b_fy_yr_id" id="b_fy_yr_id" value="{{$osrFyYear->id}}"/>
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <p class="p-sm">
                                        Click the above image to upload passport size photo
                                ...
                                <div class="form-group text-center">
                                    ...
                                    <p class="p-sm">
                                        Click the above image to upload pan card photo
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="b_f_name" id="b_f_name" placeholder=""/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label>Middle Name</label>
                                            <input type="text" class="form-control" name="b_m_name" id="b_m_name" placeholder=""/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <div class="form-group">
                                            <label>Last Name <strong>*</strong></label>
                                            <input type="text" class="form-control" name="b_l_name" id="b_l_name" placeholder=""/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label>Bidder accepted/rejected/withdrawn?</label>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                           ...
                           <!-- <div class="col-md-3 col-sm-4 col-xs-12">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label>Is the Bidder accepted/rejected?</label>
    ...
    <div class="modal fade" id="addBidderDocuments">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <form action="" method="POST" id="uploadBidderDocuments" autocomplete="off">
                    <!-- Modal body -->
                    <div class="modal-body">
                        <h5>Attachments</h5>
                                @foreach($activeBidderDocs AS $doc)
                                        <label>{{$doc->doc_name}} <strong>*</strong></label>
                                        <p id="viewBidderAttachment_{{$doc->id}}" style="@if(!isset($uploadedDoc[$doc->id])) display:none @endif">
                                            <a href="@if(isset($uploadedBidderDoc[$doc->id])){{$imgUrl.$uploadedBidderDoc[$doc->id]}}@endif" target="_blank" class="btn btn-success btn-xs" id="bidder_attachment_view_link_{{$doc->id}}">
                                                <i class="fa fa-check"></i>
                                                View {{$doc->doc_name}}
                                            </a>
                                        ...
                                        <form action="#" method="POST" id="bidderAttachmentForm_{{$doc->id}}" style="@if(isset($uploadedBidderDoc[$doc->id])) display:none @endif">
                                            <input type="hidden" name="doc_no" value="{{$doc->id}}"/>
                                            <input type="hidden" name="asset_id" value="{{$assetData->id}}"/>
                                            <input type="hidden" name="fy_yr_id" value="{{$osrFyYear->id}}"/>

                                            <input type="file" class="form-control" name="attachment"/>
                                            <button type="submit" class="btn btn-primary btn-xs" id="upload_bidder_attach_{{$doc->id}}">
                                                <i class="fa fa-upload"></i>
                                                Upload
                                            </button><br>
                                            @if(isset($uploadedBidderDoc[$doc->id]))
                                                <button type="button" class="btn btn-danger btn-xs cancel_bidder_attachment" id="cancel_bidder_attach_{{$doc->id}}" data-doc_id="{{$doc->id}}">
                                                    Cancel
                                                </button>
                                            @endif
                                        </form>
...
@section('custom_js')
    ...
    <script type="application/javascript">
        ...
        $('#bidderPrevious').on('click', function(e){
            ...
            var fy_year_id= $(this).data('fy');

            if(asset_id && fy_year_id){
                $('.page-loader-wrapper').fadeIn();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    ...
                    type: "POST",
                    url: '{{route('osr.non_tax.dw_asset.bidding.getGeneralDetails')}}',
                    dataType: "json",
                    data: {asset_id: asset_id, fy_year_id: fy_year_id},
                    cache: false,
                    success: function (data) {
                        if (data.msgType == true) {
        ...
        $('#addBidderForm').on('submit', function(e){
            ...
            if($('#addBidderForm').valid()){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '{{route('osr.non_tax.bidder.save')}}',
                    dataType: "json",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
       ...
       /* $('#b_remark_id').on('change', function(e){
        ...
        $('#bidderEntry').on('click', function(e){
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{route('osr.non_tax.bidder.status_update')}}',
                dataType: "json",
                data: {asset_id:asset_id, fy_year_id:fy_year_id},
                cache: false,
                success: function (data) {
        ...
        $('#upload_report').on('submit', function(e){
            ...
            if($('#upload_report').valid()) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url:  '{{route('osr.non_tax.bidder.report_upload')}}',
                    dataType: "json",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
        ...
        $('#finalSubmit').on('click', function(e) {
            ...
            var asset_id= {{$assetData->id}};
            var fy_year_id= {{$osrFyYear->id}};
            ...
            swal({
                ...
                case "catch":
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "{{route('osr.non_tax.bidder.final_submit')}}",
                        dataType: "json",
                        data: {work_order_no: work_order_no, security_deposit: security_deposit, managed_by: managed_by, file_no: file_no, awarded_date: awarded_date, asset_id: asset_id, fy_year_id: fy_year_id},
                        cache: false,
                        success: function (data) {
                            if (data.msgType == true) {
        ...
        $('.editBidder').on('click', function(e){
            ...
            $.ajax({
                ...
                type: "POST",
                url: '{{route('osr.non_tax.bidder.getById')}}',
                dataType: "json",
                data: {bid: bid},
                cache: false,
                success: function (data) {
        ...
        $('#editBidderForm').on('submit', function(e){
            ...
            if($('#editBidderForm').valid()){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    url: '{{route('osr.non_tax.bidder.edit')}}',
                    dataType: "json",
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
