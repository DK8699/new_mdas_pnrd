        ...
        <div class="row mt40">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center">
                    Defaulter of Gram Panchayats under Anchalik Panchayat : {{$data['apData']->anchalik_parishad_name}} Zila Parishad : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})
                </div>
                        ...
                        <table class="table table-bordered table-striped" id="dataTable1">
                            ...
                            @foreach($data['gpList'] as $gp)
                                <tr>
                                    ...
                                    <td class="text-left">
                                        <a href="{{route('osr.non_tax.asset.common.branch_list_settlement_defaulter', [encrypt($data['fy_id']), encrypt('DEFAULTER'), encrypt('GP'), encrypt($data['zpData']->id), encrypt($data['apData']->id), encrypt($gp->id)])}}">
                                    ...
                                    <a href="#" data-gpfyyear="{{$data['fy_id']}}" data-zid="{{$data['zpData']->id}}" data-apid="{{$data['apData']->id}}" data-gpid="{{$gp->id}}" data-gpname="{{$gp->gram_panchayat_name}}" class="listOfGPDefaulterModalViewC">
        ...
        $(document).ready(function () {
            $('#dataTable1').DataTable({
                ...
                buttons: [
                                {
                                    extend:    'excelHtml5',
                                    title:      'Defaulter of Gram Panchayats under Anchalik Panchayat : {{$data['apData']->anchalik_parishad_name}} Zila Parishad : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})',
