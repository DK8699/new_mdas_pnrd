        ...
        <div class="row mt40">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center">
                    Defaulter of {{$data['branchData']->branch_name}}, Gram Panchayat: {{$data['gpData']->gram_panchayat_name}} under Anchalik Panchayat : {{$data['apData']->anchalik_parishad_name}} under Zila Parishad : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})
                </div>
