                    ...
                    <table class="table table-bordered table-striped" id="dataTable1">
                        ...
                        @foreach($data['gpList'] as $gp)
                            <tr>
								...
								<td>
                                    @if(isset($data['defaulter'][$gp->gram_panchyat_id]))
                                        ...
                                        {{$data['defaulter'][$gp->gram_panchyat_id]}}
                                        </a>
                                    @else
                                        {{'0'}}
                                    @endif
        ...
        $(document).ready(function () {
            $('#dataTable1').DataTable({
                ...
                buttons: [
                                {
                                    extend:    'excelHtml5',
                                    title:     'Defaulter List Of Gram Panchayats : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})',
