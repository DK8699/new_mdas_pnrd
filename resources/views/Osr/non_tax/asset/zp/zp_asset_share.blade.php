    ...
    <div class="row mt40">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center">
                Share distribution under various categories of Zila Parishad : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="dataTable1">
                        ...
                        @foreach($data['branches'] as $branch)
                            <tr >
                                <td>{{$i}}</td>
                                <td><a href="{{url('osr/non_tax/asset/zp/zp_asset_share_branch')}}/{{encrypt($data['fy_id'])}}/{{encrypt($branch->id)}}">{{$branch->branch_name}}</a></td>
                                <td>1,00,000</td>
								<td>20,000</td>
                                <td>40,000</td>
                                <td>40,000</td>
