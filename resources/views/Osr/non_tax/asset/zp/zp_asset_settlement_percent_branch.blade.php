    ...
    <div class="row mt40">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center">
                Settlement Status for {{$data['branchData']->branch_name}} of Zila Parishad : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})
            </div>
                        ...
                        @foreach($data['assetList'] as $li)
                            <tr>
                                ...
                                <td class="text-left">
									...
									<!--<a href="{{url('osr/non_tax/asset/zp/zp_asset_settlement_percent_branch')}}/{{encrypt($data['fy_id'])}}/{{encrypt($li->id)}}">
                                        {{$li->asset_code}}
                                    </a>-->
                                </td>
                                <td class="text-left">
