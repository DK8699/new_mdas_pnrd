        ...
        <div class="row mt40">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading" style="text-align: center">
                    Settlement Status for {{$data['branchData']->branch_name}} of Gram Panchayat: {{$data['gpData']->gram_panchayat_name}} under Anchalik Panchayat: {{$data['apData']->anchalik_parishad_name}} of Zila Parishad : {{$data['zpData']->zila_parishad_name}} ({{$data['fyData']->fy_name}})
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="dataTable1">
                            ...
                            <tr class="bg-primary text-center">
                                ...
                                <td>Asset Code</td>
                                <td>Asset Name</td>
                                <td>Shorlist Status</td>
                                <td>Settled Status</td>
                            </tr>
                            </thead>
