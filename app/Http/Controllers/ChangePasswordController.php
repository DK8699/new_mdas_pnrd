...
class ChangePasswordController extends Controller
{
    ...
    public function user_dashboard(Request $request)
    {
        ...
        if ($master_level == 2) {
            ...
            $userCountList = MdasUser::join('mdas_master_levels AS l', 'l.id', '=', 'mdas_users.mdas_master_level_id')
                ...
                ->where('mdas_users.zp_id', $zp_code)
        ...
        return view('UsersManagement.user_dashboard', compact('data'));
    }
    ...
    public function ApUser(Request $request)
    {
        ...
        return view('UsersManagement.ap_user_management', compact('mdasUserList', 'imgUrl'));
    }
    ...
    public function GpUser(Request $request)
    {
        ...
        return view('UsersManagement.gp_user_management', compact('mdasUserList', 'imgUrl'));
    }
    ...
    public function profile()
    {
        ...
        $data = ['fy_id' => NULL];
        return view('UsersManagement.profile', compact('mdasUser', 'imgUrl', 'data'));
    }
