...
class CourtCasesRecipientsController extends Controller
{
    ...
    public function add_recipients(Request $request){
        ...
        return view('CourtCases.addRecipients',compact('districts','court_cases_submitted_by'));
    }
    ...
    public function recipient_save(Request $request){
        ...
        try {
            ...
            $courtCaseRecipientEntry->district_id = Auth::user()->district_code;
    ...
    public function view_recipients(Request $request){
        ...
        $court_cases_recipients = CourtCasesRecipient::leftJoin('districts as d','d.id','=','court_cases_recipients.district_id')
                                                    ->where('court_cases_recipients.district_id','=',Auth::user()->district_code)
        ...
        return view('CourtCases.viewRecipients',compact('districts','blocks','court_cases_submitted_by','court_cases_recipients'));
    }
    ...
    public function editRecipient(Request $request){
        ...
        $updateArray = [
            ...
            'district_id' => Auth::user()->district_code,
