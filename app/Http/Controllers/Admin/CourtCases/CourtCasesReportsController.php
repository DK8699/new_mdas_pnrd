...
class CourtCasesReportsController extends Controller
{
    ...
    public function list_status_report(Request $request) {
        ...
        return view('admin.CourtCases.listStatusReport', compact('districts', 'court_cases', 'court_cases_type', 'court_cases_nature', 'court_cases_status', 'court_cases_under', 'court_cases_submitted_by',
