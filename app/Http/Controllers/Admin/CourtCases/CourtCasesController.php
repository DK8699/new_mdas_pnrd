...
class CourtCasesController extends Controller
{
	public function __construct() {
        $this->middleware(['auth', 'user_courtcase']);
    }
    public function dashboard(Request $request) {
        ...
        return view('admin.CourtCases.dashboard', compact('districts', 'court_cases_type', 'court_cases_nature', 'court_cases_status', 'rev_case_start', 'rev_case_end',
    ...
    public function add_court_case(Request $request) {
            ...
            return view('admin.CourtCases.addCourtCase', compact('districts', 'court_cases_type', 'court_cases_nature', 'court_cases_status', 'court_cases_under', 'court_cases_submitted_by'));
    }
    public function add_court_case_details(Request $request) {
        if(Auth::check())
        {
            ...
            // return view('admin.CourtCases.addCourtCase', compact('districts', 'court_cases_type', 'court_cases_submitted_by'));
        }
        else
        {
          Auth::logout();
    ...
    public function list_court_case(Request $request) {
        ...
        return view('admin.CourtCases.listCourtCases', compact('districts', 'court_cases', 'court_cases_type', 'court_cases_nature', 'court_cases_status', 'court_cases_under', 'court_cases_submitted_by'));
    }
    ...
    public function view_court_case(Request $request) {
        if(Auth::check())
        {
            ...
            return view('admin.CourtCases.viewCourtCase', compact('districts', 'court_cases', 'court_cases_type', 'court_cases_nature', 'court_cases_status', 'court_cases_under', 'court_cases_submitted_by',
    ...
    public function manage_court_case(Request $request) {
        if(Auth::check())
        {
            ...
            return view('admin.CourtCases.manageCourtCase', compact('districts', 'court_cases', 'court_cases_type', 'court_cases_nature', 'court_cases_status', 'court_cases_under', 'court_cases_submitted_by',
            'court_cases_parawise_comments', 'court_cases_instruction', 'court_cases_affidavit', 'court_cases_additional_affidavit', 'court_cases_final_order', 'court_cases_speaking_order', 'court_cases_interim_order'));
        }
        else
        {
